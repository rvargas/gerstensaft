		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<dl>
					...
					<g:if test="${userInstance?.lastTime}">
						<dt><g:message code="user.lastTime.label" default="Last Time" /></dt>
						
							<dd><g:formatDate date="${userInstance?.lastTime}" /></dd>
					...
					<g:if test="${userInstance?.gone}">
						<dt><g:message code="user.gone.label" default="Gone" /></dt>
						
							<dd><g:formatBoolean boolean="${userInstance?.gone}" /></dd>
